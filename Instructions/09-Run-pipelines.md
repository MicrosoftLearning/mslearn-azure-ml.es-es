---
lab:
  title: Creación de canalizaciones en Azure Machine Learning
---

# Creación de canalizaciones en Azure Machine Learning

Puede usar el SDK de Python para realizar todas las tareas necesarias para crear y ejecutar una solución de aprendizaje automático en Azure. En lugar de realizar estas tareas individualmente, puede usar canalizaciones para organizar los pasos necesarios para preparar los datos, ejecutar scripts de entrenamiento y otras tareas.

En este ejercicio, ejecutará varios scripts como un trabajo de canalización.
...
El código para compilar y enviar una canalización con el SDK de Python se proporciona en un cuaderno.

1. Abra el cuaderno **Labs/09/Run a pipeline job.ipynb**.
