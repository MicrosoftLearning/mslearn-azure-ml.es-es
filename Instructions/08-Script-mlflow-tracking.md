---
lab:
  title: Uso de MLflow para realizar un seguimiento de los trabajos de entrenamiento
---

# Uso de MLflow para realizar un seguimiento de los trabajos de entrenamiento

MLflow es una plataforma de código abierto para administrar todo el ciclo de vida del aprendizaje automático. MLflow Tracking es un componente que registra las métricas de trabajo de entrenamiento, los parámetros y los artefactos de modelo y realiza un seguimiento de ellos.

En este ejercicio, usará MLflow para realizar un seguimiento de la ejecución del entrenamiento del modelo como un trabajo de comando.
...
Ahora que tiene todos los recursos necesarios, puede ejecutar el cuaderno para enviar el trabajo, que usa MLflow para realizar un seguimiento de los parámetros, las métricas y los artefactos del modelo.

1. Abra el cuaderno **Labs/08/Use MLflow para realizar un seguimiento de jobs.ipynb**.
