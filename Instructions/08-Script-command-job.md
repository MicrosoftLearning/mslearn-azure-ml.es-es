...
1. Asigne el nombre `train-classification-model.py` al archivo nuevo. 
...
1. Revise las propiedades del trabajo. Tenga en cuenta que **Comando** muestra el valor del parámetro **comando** del trabajo de comandos: el comando que ejecutó para ejecutar el script.
