...
## Configurar la estación de trabajo con el Estudio de Azure Machine Learning
...
1. Una vez completado el trabajo, puede encontrar la *AUC* y la *Precisión* del modelo en **Métricas**. 
1. En **Salidas y registros**, encontrará lo siguiente:
    - El archivo pickle del modelo en la carpeta **Salidas**. 
    - Salida del script en **user_logs/std_log.txt**. La salida de las instrucciones de **impresión** del script se mostrará aquí. Si hay un error debido a un problema con el script, también encontrará el mensaje de error aquí.
